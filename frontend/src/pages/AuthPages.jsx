...
export function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      await loginUser(res.data.access_token, { email, role: res.data.role });
      if (res.data.role === 'seeker') navigate('/jobs');
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-xl sm:px-10 border border-gray-200">
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <button
              ...
              className="w-full flex justify-center py-2.5 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-70"
            >
